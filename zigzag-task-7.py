...
class ToolCard(Card):
    ...
    def SetCardToolkit(self):
        NewKit = ""
        while (NewKit != "a" and NewKit != "b" and NewKit != "c"):
            NewKit = input("Choose a toolkit for multi card (a,b,c): ").lower()
        self._Kit = NewKit
    ####################
...
class CardCollection():
    ...
    # Change made here #
    ####################
    def SetCardToolkit(self, CardChoice):
        self._Cards[CardChoice].SetCardToolkit()
    ####################
