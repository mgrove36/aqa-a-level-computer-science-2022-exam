# UPDATE: Practise tasks 1 and 2 have been completed in this version of the 
# skeleton program
# ------------------------------------------------------------------
...
class CardCollection():
    ...
    def DisplayStats(self):
        return f"There is a {round(100 * self.__NumKeys / self.GetNumberOfCards(), 2)}% chance that the next card will be a key, a {round(100 * self.__NumFiles / self.GetNumberOfCards(), 2)}% chance that it will be a file and a {100 * round(self.__NumPicks / self.GetNumberOfCards(), 2)}% chance that it will be a pick."
    ####################
