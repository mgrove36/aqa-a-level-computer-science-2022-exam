...
class Breakthrough():
            ...
            while not self.__GameOver:
                ...
                while not self.__LockSolved and not self.__GameOver:
                    ...
                    ####################
                        ...
                        while self.__Deck.GetNumberOfCards() > 0:
                            self.__Deck.RemoveCard(self.__Deck.GetCardNumberAt(0))
                    ####################
    ...
    def __GetChoice(self):
        ...
        # Change made here #
        ####################
        Choice = input(f"(D)iscard inspect, (U)se card{'' if self.__CurrentLock.GetPeekUsed() else ', (P)eek'}, (Q)uit:> ").upper()
        ####################
